        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-3 " >
                    ...
                    <h3 style="font-weight:bold">Vacant Land / Plot / Site</h3>
                    ...
                    <form class="form" id="SalePostForm" name="SalePostForm" method="post"
                        ...
                        <div class="form-group center-block">
                          ...
                          <div id='advdisplay' class='btn-lg ' >
                            <div class=" " style="font-size:17px">
                              <input type="radio" id="owner" name="SalePostUserType" value="O"  class="" style="cursor:pointer" checked="checked"  >
                              <label for="owner" style="cursor:pointer">Owner</label>
                              &nbsp;|&nbsp;
                              <input type="radio" id="builder" name="SalePostUserType" value="B" class="form-control."  style="cursor:pointer">
                              <label for="builder" style="cursor:pointer">Builder</label>
                              <br>
                              <input type="radio" id="agent" name="SalePostUserType" value="A" class="form-control."  style="cursor:pointer">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                              ...
                              <span class="input-group-addon">$. Per
                                <span id="SalePostUnitDisplay"></span>
                              </span>
                            </div>
                        </div>
                        ...
                        function displayvals() {
                          ...
                          $( "span#SalePostUnitDisplay" ).html( singlevalue );
                        }
...
-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="SalePostPropType" value="1" >
                            <div id="" class="btnbgc">
