        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-md-offset-3 " >
                    ...
                    <h3 style="font-weight:bold">Residential House / Bungalow / Villa</h3>
                    ...
                    <form class="form" id="RentPostForm" name="RentPostForm" method="post"
                        ...
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                <input type="text" id="RentPostBuiltSize" name="RentPostBuiltSize"  maxlength="20" title=""
...
-->
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="RentPostPropType" value="1" >
                            <div id="" class="btnbgc">
