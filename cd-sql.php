...
<?php
// Display - Direct
$result_display_advantage = mysqli_query($con,
...
$result_display_cap = mysqli_query($con,
...
$result_display_ctt = mysqli_query($con,
...
$result_display_extranet = mysqli_query($con,
...
$result_display_guardian3 = mysqli_query($con,
...
$result_display_zisa = mysqli_query($con,
...
$result_mobile_direct = mysqli_query($con,
...
$result_display_workbench = mysqli_query($con,
...
// Display - Media
$result_display_alchemy = mysqli_query($con,
...
$result_display_cobalt_api = mysqli_query($con,
...
$result_display_cobalt_ui = mysqli_query($con,
...
$result_display_pub_admin = mysqli_query($con,
...
$result_display_pub_ui = mysqli_query($con,
...
$result_display_tag_manager = mysqli_query($con,
...
$result_video_cvus = mysqli_query($con,
...
$result_video_pvs = mysqli_query($con,
...
$result_video_vbox = mysqli_query($con,
...
// Media Plex
$result_display_adserver = mysqli_query($con,
...
$result_display_adserver_ui = mysqli_query($con,
...
$result_video_contextual = mysqli_query($con,
...
$result_display_forecast = mysqli_query($con,
...
// Summary Table
$result_summary_gnmi_msdc1 = mysqli_query($con, "SELECT * FROM summary WHERE application = 'GNMI-MSDC1' ");
$row_summary_gnmi_msdc1 = mysqli_fetch_array($result_summary_gnmi_msdc1) ;

$result_summary_gnmi_msdc2 = mysqli_query($con, "SELECT * FROM summary WHERE application = 'GNMI-MSDC2' ");
$row_summary_gnmi_msdc2 = mysqli_fetch_array($result_summary_gnmi_msdc2) ;

$result_summary_gnmi_l2l3 = mysqli_query($con, "SELECT * FROM summary WHERE application = 'GNMI-L2L3' ");
$row_summary_gnmi_l2l3 = mysqli_fetch_array($result_summary_gnmi_l2l3) ;

$result_summary_gnmi_redcastle = mysqli_query($con, "SELECT * FROM summary WHERE application = 'GNMI-REDCASTLE' ");
$row_summary_gnmi_redcastle = mysqli_fetch_array($result_summary_gnmi_redcastle) ;

$result_summary_netconf_msdc1 = mysqli_query($con, "SELECT * FROM summary WHERE application = 'NETCONF-MSDC1' ");
$row_summary_netconf_msdc1 = mysqli_fetch_array($result_summary_netconf_msdc1) ;

$result_summary_netconf_msdc2 = mysqli_query($con, "SELECT * FROM summary WHERE application = 'NETCONF-MSDC2' ");
$row_summary_netconf_msdc2 = mysqli_fetch_array($result_summary_netconf_msdc2) ;

$result_summary_netconf_mpls = mysqli_query($con, "SELECT * FROM summary WHERE application = 'NETCONF-MPLS' ");
$row_summary_netconf_mpls = mysqli_fetch_array($result_summary_netconf_mpls) ;

$result_summary_netconf_l2l3 = mysqli_query($con, "SELECT * FROM summary WHERE application = 'NETCONF-L2L3' ");
$row_summary_netconf_l2l3 = mysqli_fetch_array($result_summary_netconf_l2l3) ;

$result_summary_netconf_vxlan_r = mysqli_query($con, "SELECT * FROM summary WHERE application = 'NETCONF-VXLAN-R' ");
$row_summary_netconf_vxlan_r = mysqli_fetch_array($result_summary_netconf_vxlan_r) ;

$result_summary_netconf_redcastle = mysqli_query($con, "SELECT * FROM summary WHERE application = 'NETCONF-REDCASTLE' ");
$row_summary_netconf_redcastle = mysqli_fetch_array($result_summary_netconf_redcastle) ;

$result_summary_netconf_vxlan = mysqli_query($con, "SELECT * FROM summary WHERE application = 'NETCONF-VXLAN' ");
$row_summary_netconf_vxlan = mysqli_fetch_array($result_summary_netconf_vxlan) ;

$result_summary_rest = mysqli_query($con, "SELECT * FROM summary WHERE application = 'REST-MSDC2' ");
$row_summary_rest1 = mysqli_fetch_array($result_summary_rest) ;

$result_summary_rest = mysqli_query($con, "SELECT * FROM summary WHERE application = 'REST-REDCASTLE' ");
$row_summary_rest2 = mysqli_fetch_array($result_summary_rest) ;
$result_summary_rest = mysqli_query($con, "SELECT * FROM summary WHERE application = 'REST-VXLAN' ");
$row_summary_rest3 = mysqli_fetch_array($result_summary_rest) ;
$result_summary_rest = mysqli_query($con, "SELECT * FROM summary WHERE application = 'REST-MSDC1' ");
$row_summary_rest4 = mysqli_fetch_array($result_summary_rest) ;
$result_summary_rest = mysqli_query($con, "SELECT * FROM summary WHERE application = 'REST-MPLS' ");
$row_summary_rest5 = mysqli_fetch_array($result_summary_rest) ;

$result_summary_rest6 = mysqli_query($con, "SELECT * FROM summary WHERE application = 'REST-L2L3' ");
$row_summary_rest6 = mysqli_fetch_array($result_summary_rest6) ;

$result_summary_rest7 = mysqli_query($con, "SELECT * FROM summary WHERE application = 'REST-VXLAN-R' ");
$row_summary_rest7 = mysqli_fetch_array($result_summary_rest7) ;

$result_summary_l2l3 = mysqli_query($con, "SELECT * FROM summary WHERE application = 'L2L3' ");
$row_summary_l2l3 = mysqli_fetch_array($result_summary_l2l3) ;
//

// Summation
$summary_test_totals = mysqli_query($con, "SELECT SUM(total) FROM summary ");
$sum_test_totals = mysqli_fetch_row($summary_test_totals);

$summary_test_automated = mysqli_query($con, "SELECT SUM(automated) FROM summary ");
$sum_test_automated = mysqli_fetch_row($summary_test_automated);

$summary_test_percent = mysqli_query($con, "SELECT SUM(percent) FROM summary ");
...
// Detailed Table
$detailed_smoke_alchemy = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'ALCHEMY' && type = 'Smoke'");
$smoke_alchemy = mysqli_fetch_row($detailed_smoke_alchemy) ;
$detailed_regression_alchemy = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'ALCHEMY' && type = 'Regression' ");
$regression_alchemy = mysqli_fetch_row($detailed_regression_alchemy) ;
$detailed_api_alchemy = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'ALCHEMY' && type = 'API' ");
$api_alchemy = mysqli_fetch_row($detailed_api_alchemy) ;
$detailed_automated_alchemy = mysqli_query($con, "SELECT SUM(automated) FROM detailed WHERE application = 'ALCHEMY' ");
$automated_alchemy = mysqli_fetch_row($detailed_automated_alchemy) ;

$detailed_smoke_zisa = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'ZISA' && type = 'Smoke'");
$smoke_zisa = mysqli_fetch_row($detailed_smoke_zisa) ;
$detailed_api_zisa = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'ZISA' && type = 'API' ");
$api_zisa = mysqli_fetch_row($detailed_api_zisa) ;
$detailed_automated_zisa = mysqli_query($con, "SELECT SUM(automated) FROM detailed WHERE application = 'ZISA' ");
$automated_zisa = mysqli_fetch_row($detailed_automated_zisa) ;

$detailed_smoke_cap = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'CAP' && type = 'Smoke'");
$smoke_cap = mysqli_fetch_row($detailed_smoke_cap) ;
$detailed_automated_cap = mysqli_query($con, "SELECT SUM(automated) FROM detailed WHERE application = 'CAP' ");
$automated_cap = mysqli_fetch_row($detailed_automated_cap) ;

$detailed_smoke_cobalt = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'COBALT' && type = 'Smoke'");
$smoke_cobalt = mysqli_fetch_row($detailed_smoke_cobalt) ;
$detailed_regression_cobalt = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'COBALT' && type = 'Regression' ");
$regression_cobalt = mysqli_fetch_row($detailed_regression_cobalt) ;
$detailed_api_cobalt = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'COBALT' && type = 'API' ");
$api_cobalt = mysqli_fetch_row($detailed_api_cobalt) ;
$detailed_automated_cobalt = mysqli_query($con, "SELECT SUM(automated) FROM detailed WHERE application = 'COBALT' ");
$automated_cobalt = mysqli_fetch_row($detailed_automated_cobalt) ;

$detailed_smoke_ctm = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'CTM' && type = 'Smoke'");
$smoke_ctm = mysqli_fetch_row($detailed_smoke_ctm) ;
$detailed_automated_ctm = mysqli_query($con, "SELECT SUM(automated) FROM detailed WHERE application = 'CTM' ");
$automated_ctm = mysqli_fetch_row($detailed_automated_ctm) ;

$detailed_regression_guardian = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'GUARDIAN3' && type = 'Regression'");
$regression_guardian = mysqli_fetch_row($detailed_regression_guardian) ;
$detailed_automated_guardian = mysqli_query($con, "SELECT SUM(automated) FROM detailed WHERE application = 'GUARDIAN3' ");
$automated_guardian = mysqli_fetch_row($detailed_automated_guardian) ;

$detailed_api_forecast = mysqli_query($con, "SELECT automated FROM detailed WHERE application = 'FORECAST' && type = 'API' ");
